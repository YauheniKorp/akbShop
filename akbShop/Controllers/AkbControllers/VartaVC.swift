...
//    @objc func addBusket(_ target: UITableViewCell) {
//
//        basketArray.append(images[0])
//
//    }
}
...
extension VartaVC {
    ...
    func fetchData() -> [AkbCell] {
        ...
        let image1 = AkbCell(image: Images.varta40AsiaEuro, titleLabel: "Varta 40 Ah Asia.\nГабариты: 187х140х227 мм.\nЕмкость: 40 Ач.\nПусковой ток: 300 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "145р")
        let image2 = AkbCell(image: Images.varta40AsiaRus, titleLabel: "Varta 40 Asia.\nГабариты: 187х140х227 мм.\nЕмкость: 40 Ач.\nПусковой ток: 300 А.\nПолярность: прямая (+ -).\nЦена: ", priceLabel: "145р")
        let image3 = AkbCell(image: Images.varta45AsiaEuro, titleLabel: "Varta 45 Ah Asia.\nГабариты: 238х129х227 мм.\nЕмкость: 45 Ач.\nПусковой ток: 330 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "165р")
        let image4 = AkbCell(image: Images.varta45AsiaRus, titleLabel: "Varta 45 Ah Asia.\nГабариты: 238х129х227 мм.\nЕмкость: 45 Ач.\nПусковой ток: 330 А.\nПолярность: прямая (+ -).\nЦена: ", priceLabel: "165р")
        let image5 = AkbCell(image: Images.varta60AsiaEuro, titleLabel: "Varta 60 Ah Asia.\nГабариты: 232х173х225 мм.\nЕмкость: 60 Ач.\nПусковой ток: 540 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "240р")
        let image6 = AkbCell(image: Images.varta60AsiaRus, titleLabel: "Varta 60 Ah Asia.\nГабариты: 232х173х225 мм.\nЕмкость: 60 Ач.\nПусковой ток: 540 А.\nПолярность: прямая (+ -).\nЦена: ", priceLabel: "240р")
        let image7 = AkbCell(image: Images.varta70AsiaEuro, titleLabel: "Varta 70 Ah Asia.\nГабариты: 261х175х220 мм.\nЕмкость: 70 Ач.\nПусковой ток: 630 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "280р")
        let image8 = AkbCell(image: Images.varta70AsiaRus, titleLabel: "Varta 70 Ah Asia.\nГабариты: 261х175х220 мм.\nЕмкость: 70 Ач.\nПусковой ток: 630 А.\nПолярность: прямая (+ -).\nЦена: ", priceLabel: "280р")
        let image9 = AkbCell(image: Images.varta95AsiaEuro, titleLabel: "Varta 95 Ah Asia.\nГабариты: 306х173х225 мм.\nЕмкость: 95 Ач.\nПусковой ток: 830 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "320р")
        let image10 = AkbCell(image: Images.varta95AsiaRus, titleLabel: "Varta 95 Ah Asia.\nГабариты: 306х173х225 мм.\nЕмкость: 95 Ач.\nПусковой ток: 830 А.\nПолярность: прямая (+ -).\nЦена: ", priceLabel: "320р")
        let image11 = AkbCell(image: Images.varta44, titleLabel: "Varta 44 Ah.\nГабариты: 207х175х175 мм.\nЕмкость: 44 Ач.\nПусковой ток: 440 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "185р")
        let image12 = AkbCell(image: Images.varta60, titleLabel: "Varta 60 Ah.\nГабариты: 242х175х190 мм.\nЕмкость: 60 Ач.\nПусковой ток: 540 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "215р")
        let image13 = AkbCell(image: Images.varta74Blue, titleLabel: "Varta 74 Ah Blue Dynamic.\nГабариты: 278х175х190 мм.\nЕмкость: 74 Ач.\nПусковой ток: 680 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "240р")
        let image14 = AkbCell(image: Images.varta80, titleLabel: "Varta 80 Ah Blue Dynamic.\nГабариты: 315х175х175 мм.\nЕмкость: 80 Ач.\nПусковой ток: 740 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "280р")
        let image15 = AkbCell(image: Images.varta95, titleLabel: "Varta 95 Ah Blue Dynamic.\nГабариты: 353х175х190 мм.\nЕмкость: 95 Ач.\nПусковой ток: 800 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "320р")
        let image16 = AkbCell(image: Images.varta52, titleLabel: "Varta 52 Ah Silver Dynamic.\nГабариты: 204х175х175 мм.\nЕмкость: 52 Ач.\nПусковой ток: 510 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "240р")
        let image17 = AkbCell(image: Images.varta54, titleLabel: "Varta 54 Ah Silver Dynamic.\nГабариты: 204х175х190 мм.\nЕмкость: 54 Ач.\nПусковой ток: 520 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "250р")
        let image18 = AkbCell(image: Images.varta61, titleLabel: "Varta 61 Ah Silver Dynamic.\nГабариты: 242х175х175 мм.\nЕмкость: 61 Ач.\nПусковой ток: 600 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "290р")
        let image19 = AkbCell(image: Images.varta63, titleLabel: "Varta 63 Ah Silver Dynamic.\nГабариты: 242х175х190.\nЕмкость: 63 Ач.\nПусковой ток: 610 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "300р")
        let image20 = AkbCell(image: Images.varta74Silver, titleLabel: "Varta 74 Ah Silver Dynamic.\nГабариты: 278х175х175 мм.\nЕмкость: 74 Ач.\nПусковой ток: 750 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "355р")
        let image21 = AkbCell(image: Images.varta77, titleLabel: "Varta 77 Ah Silver Dynamic.\nГабариты: 278х175х190 мм.\nЕмкость: 77 Ач.\nПусковой ток: 780 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "380р")
        let image22 = AkbCell(image: Images.varta85, titleLabel: "Varta 85 Ah Silver Dynamic.\nГабариты: 315х175х175 мм.\nЕмкость: 85 Ач.\nПусковой ток: 850 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "390р")
        let image23 = AkbCell(image: Images.varta100, titleLabel: "Varta 100 Ah Silver Dynamic.\nГабариты: 353х175х190 мм.\nЕмкость: 100 Ач.\nПусковой ток: 830 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "450р")
        let image24 = AkbCell(image: Images.varta110, titleLabel: "Varta 110 Ah Silver Dynamic.\nГабариты: 393х175х190 мм.\nЕмкость: 110 Ач.\nПусковой ток: 920 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "540р")
        let image25 = AkbCell(image: Images.varta60AGM, titleLabel: "Varta 60 Ah AGM.\nГабариты: 242х175х190 мм.\nЕмкость: 60 Ач.\nПусковой ток: 680 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "490р")
        let image26 = AkbCell(image: Images.varta70AGM, titleLabel: "Varta 70 Ah AGM.\nГабариты: 278х175х190 мм.\nЕмкость: 70 Ач.\nПусковой ток: 760 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "525р")
        let image27 = AkbCell(image: Images.varta80AGM, titleLabel: "Varta 80 Ah AGM.\nГабариты: 315х175х190 мм.\nЕмкость: 80 Ач.\nПусковой ток: 800 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "560р")
        let image28 = AkbCell(image: Images.varta95AGM, titleLabel: "Varta 95 Ah AGM.\nГабариты: 353х175х190 мм.\nЕмкость: 95 Ач.\nПусковой ток: 850 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "650р")
        let image29 = AkbCell(image: Images.varta105AGM, titleLabel: "Varta 105 Ah AGM.\nГабариты: 393х175х190 мм.\nЕмкость: 105 Ач.\nПусковой ток: 950 А.\nПолярность: обратная (- +).\nЦена: ", priceLabel: "750р")
